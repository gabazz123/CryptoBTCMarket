...
using RestSharp;
using CryptoBTCMarket.Helpers;
using RestSharp.Deserializers;
using CryptoBTCMarket.Constants;
    ...
    class BTCFunctions
    {
        ...
        public static string SendRequest(string action, string postData)
        {
            ...
            try
            {
                ...
                var signature = SecurityHelper.ComputeHash(Base64Encode(ApplicationConstants.PRIVATE_KEY), stringToSign);
        ...
        ///     The generated timestamp for the request - must be recieved by BTC within 30 seconds or thehgjg
